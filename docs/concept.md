...
- **Shell UI accessibility** is a **hard requirement**.
...
- **Open source license** (e.g. MIT, Apache-2.0, AGPL—trade-offs differ).
...
- **Updater** mechanism per platform.

---

## Proposed solution (summary)

Address the problems above using **disciplined system engineering**: a **cross-platform desktop** library application with **RBAC**, **full-text search** (including **OCR** where needed for searchability), **tagging** and **rich metadata**, **honest handling** of **missing files** and **deletion**, **accessibility** in the shell, and **clear** separation between **library services** and **native reading/printing**. **Web**, **sync**, **APIs**, and **performance SLAs** are intentionally **out of initial scope** unless reprioritized.
