...
- Scope boundaries defined? **Yes** (see [§2.2](./srs.md#22-scope), [§13](./srs.md#13-waiting-room-deferred-scope))
- Advancement to Requirements authorized? **Yes**
- Advancement to High-Level Architecture authorized? **Yes** (2026-04-06; project owner / sole stakeholder; recorded in [§16](./srs.md#16-phase-gate-declaration) and [§Approval](./srs.md#approval))
...
- **End-user documentation** (user manual, quick-start, in-app Help entry) per [NFR-007](./srs.md#nfr-007--end-user-documentation-and-help).
- Operational and diagnostic logging for client and server, configurable via Settings / administration surfaces, per [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server) and [NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness).
- User and session administration (account lifecycle, sessions, throttling), corpus storage model, catalog browse, search semantics, index rebuild, metadata validation and concurrency — [FR-031](./srs.md#fr-031--user-account-and-role-administration) – [FR-041](./srs.md#fr-041--concurrent-metadata-updates).
...
| **Audit log**       | Security- and compliance-oriented records (who did what, when, on which resource) per [FR-026](./srs.md#fr-026--audit-logging "FR-026 Audit Logging") — distinct from operational/diagnostic streams unless implementation maps categories without blurring toggle semantics (DD).       |
| **Operational log** | Routine application and lifecycle events suitable for monitoring healthy operation ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server "FR-029 Operational and Diagnostic Logging Client and Server")) — not a substitute for audit where audit is required. |
| **Diagnostic log**  | Warnings, errors, and troubleshooting detail for support and fault analysis ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server "FR-029 Operational and Diagnostic Logging Client and Server")).                                                             |
...
- [FR-001](./srs.md#fr-001--catalog-records)–[FR-008](./srs.md#fr-008--tag-filtering) (catalog, metadata, import, types, index, search, tags, keywords)
- [FR-009](./srs.md#fr-009--keywords-when-indexing-blocked)–[FR-012](./srs.md#fr-012--remove-from-catalog-vs-delete-on-disk) (duplicates, missing file, remove)
- [FR-013](./srs.md#fr-013--server-authority-for-security)–[FR-019](./srs.md#fr-019--open-in-native-reader) (security, deployment, auth, RBAC, tenant, open reader)
- [FR-020](./srs.md#fr-020--settings-client-preferences)–[FR-022](./srs.md#fr-022--application-theme) (Settings, reader prefs, theme)
- [FR-023](./srs.md#fr-023--ocr-for-searchability)–[FR-030](./srs.md#fr-030--release-information) (OCR, a11y, English, audit, passwords, log retention, ops/diagnostic logs, release)
- [FR-031](./srs.md#fr-031--user-account-and-role-administration)–[FR-041](./srs.md#fr-041--concurrent-metadata-updates) (administration, sessions, storage, browse, search detail, index admin, metadata).
...
**Acceptance criteria:** Given a successful import, a durable catalog record exists retrievable by identifier; given removal per [FR-012](./srs.md#fr-012--remove-from-catalog-vs-delete-on-disk), the record is removed or archived per documented behavior.
...
**Dependencies:** [FR-001](./srs.md#fr-001--catalog-records)

**Constraints:** —

**Notes:** Additional bibliographic fields may be added in later revisions without relaxing [FR-002](./srs.md#fr-002--metadata-fields).
...
**Acceptance criteria:** A record can have zero or more tags; users can add, remove, and filter the catalog by tag (see [FR-008](./srs.md#fr-008--tag-filtering)).
...
**Dependencies:** [FR-001](./srs.md#fr-001--catalog-records), [FR-010](./srs.md#fr-010--duplicate-detection-digest), [FR-017](./srs.md#fr-017--role-based-access-control), [FR-032](./srs.md#fr-032--initial-administrator-bootstrap)
...
**Acceptance criteria:** PDF and DOCX files selected in [FR-004](./srs.md#fr-004--deliberate-import) become catalog records with **actionable** metadata and tags per [FR-002](./srs.md#fr-002--metadata-fields) and [FR-003](./srs.md#fr-003--tags).

**Priority:** High

**Dependencies:** [FR-004](./srs.md#fr-004--deliberate-import)
...
**Description:** Where full textual content is lawfully available to the server or client pipeline without circumventing technical protection measures, the system **SHALL** build and maintain a full-text index for search ([FR-007](./srs.md#fr-007--full-text-search)).
...
**Dependencies:** [FR-005](./srs.md#fr-005--supported-document-types-v1)

**Constraints:** No requirement to bypass DRM.

**Notes:** Table-heavy and poor-quality PDFs may yield imperfect text (see [§6](./srs.md#6-deterministicprobabilistic-requirements), [§14](./srs.md#14-risk-assessment)). Search consumption of the index is specified in [FR-007](./srs.md#fr-007--full-text-search) (depends on this requirement).

---

## FR-007 — Full-text search

**Description:** The system **SHALL** provide search over the full-text index (and keyword lists per [FR-009](./srs.md#fr-009--keywords-when-indexing-blocked) where applicable), returning matching catalog records.
...
**Dependencies:** [FR-006](./srs.md#fr-006--full-text-indexing-when-permitted)

**Constraints:** —

**Notes:** “Jump to page/offset in native reader” behavior is aspirational and format-dependent; any such feature **SHALL** be documented honestly when specified in a later artifact. Query syntax and semantics (boolean, phrase, grouping) are specified in [FR-038](./srs.md#fr-038--search-query-semantics-and-results).
...
**Dependencies:** [FR-003](./srs.md#fr-003--tags)
...
**Dependencies:** [FR-001](./srs.md#fr-001--catalog-records), [FR-007](./srs.md#fr-007--full-text-search)
...
**Solo deployment** ([FR-014](./srs.md#fr-014--solo-co-located-deployment)): The system **SHALL** notify the interactive user and **SHALL** offer a controlled relink path (e.g. file dialog) to associate a new path, subject to server enforcement ([FR-013](./srs.md#fr-013--server-authority-for-security)).

**Multi-user deployment** ([FR-015](./srs.md#fr-015--multi-user-server-deployment)): Default behavior **SHALL** notify users with administrator role (or a documented corpus-maintenance / equivalent role per [FR-017](./srs.md#fr-017--role-based-access-control)) of the affected record(s) so they may remediate (relink, restore from backup, or remove per policy). Non-administrator users **SHALL** receive a documented degraded-access indication for affected records where applicable; whether they are offered relink is policy in DD (default: administrators drive remediation).
...
- **Multi-user:** Simulated missing file yields administrator-visible notification (and audit per [FR-026](./srs.md#fr-026--audit-logging) where enabled); non-admin behavior matches DD; server API denies inconsistent relink or access per [FR-013](./srs.md#fr-013--server-authority-for-security) and [FR-017](./srs.md#fr-017--role-based-access-control).

**Priority:** High

**Dependencies:** [FR-001](./srs.md#fr-001--catalog-records), [FR-017](./srs.md#fr-017--role-based-access-control)
...
**Acceptance criteria:** Default remove operation does not delete bytes without separate confirmed action; audit trail if logging enabled ([FR-026](./srs.md#fr-026--audit-logging)).
...
**Notes:** Solo loopback remains subject to same server-side enforcement in process. Authorization for import ([FR-004](./srs.md#fr-004--deliberate-import)) and for missing-file remediation UI ([FR-011](./srs.md#fr-011--missing-file-detection-and-relink)) **SHALL** be decided server-side per [FR-017](./srs.md#fr-017--role-based-access-control) so client modification cannot bypass policy.
...
**Dependencies:** [FR-013](./srs.md#fr-013--server-authority-for-security)
...
**Dependencies:** [FR-013](./srs.md#fr-013--server-authority-for-security), [FR-016](./srs.md#fr-016--authentication-v1), [FR-017](./srs.md#fr-017--role-based-access-control)
...
**Acceptance criteria:** Invalid credentials fail; successful login establishes a server-recognized session or token per HLA; passwords never stored in cleartext (see [FR-027](./srs.md#fr-027--password-storage)).
...
**Notes:** v1 relies on server-validated username/password (or documented equivalent) per Description. MFA is out of scope ([§2.2](./srs.md#22-scope)) unless explicitly reopened. Passkeys (FIDO2 / WebAuthn-class credentials as an optional sign-in path) are a candidate post-v1 enhancement ([§13](./srs.md#13-waiting-room-deferred-scope)) when platform and privacy constraints are addressed in HLA / DD.
...
**Dependencies:** [FR-016](./srs.md#fr-016--authentication-v1)
...
**Notes:** Tenant membership [FR-018](./srs.md#fr-018--tenant-boundary).
...
**Dependencies:** [FR-017](./srs.md#fr-017--role-based-access-control)
...
**Priority:** High
**Dependencies:** [FR-017](./srs.md#fr-017--role-based-access-control), [FR-021](./srs.md#fr-021--preferred-reader-per-document-type)

**Constraints:** Hand-off of search term to reader deferred / optional (waiting room).

**Notes:** Bytes may reach client as part of open—policy honesty in operator docs (NFR). Reader choice is client-side preference ([FR-020](./srs.md#fr-020--settings-client-preferences)); authorization remains server-side ([FR-013](./srs.md#fr-013--server-authority-for-security)).

---

## FR-020 — Settings (client preferences)

**Description:** The shell UI **SHALL** provide a Settings (or equivalently named) area where an authenticated user can view and change client-side preferences that do not substitute for or weaken server-enforced access control ([FR-013](./srs.md#fr-013--server-authority-for-security), [FR-017](./srs.md#fr-017--role-based-access-control)). The Settings area **SHALL** include at minimum the capabilities in [FR-021](./srs.md#fr-021--preferred-reader-per-document-type), [FR-022](./srs.md#fr-022--application-theme), and client-side controls for operational and diagnostic logging ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)) and **SHALL** be extensible so that additional client-side or documented system-level options may be added in later releases without a new top-level navigation paradigm.
...
**Constraints:** Server-side administrative options (e.g. audit retention [FR-028](./srs.md#fr-028--configurable-log-retention), server logging [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)) **MAY** appear in Settings only for users with appropriate roles and **SHALL** remain enforced on the server.

**Notes:** Exact layout (tabs vs sidebar) **TBD** DD. Further system-level knobs **TBD**; this FR establishes the facility. Administrative functions ([FR-031](./srs.md#fr-031--user-account-and-role-administration) – [FR-035](./srs.md#fr-035--session-management), [FR-039](./srs.md#fr-039--full-text-index-administration)) **MAY** live in Settings, a separate admin shell, or documented CLI (HLA) but **SHALL** remain RBAC-gated. Server logging toggles and rotation when not exposed in the desktop shell **SHALL** appear in a documented server administration surface with equivalent capabilities ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)).

---

## FR-021 — Preferred reader per document type

**Description:** For each document type the product supports for open-in-reader in v1 (at minimum those in [FR-005](./srs.md#fr-005--supported-document-types-v1): PDF and DOCX), Settings ([FR-020](./srs.md#fr-020--settings-client-preferences)) **SHALL** allow the user to specify a preferred external application used when invoking [FR-019](./srs.md#fr-019--open-in-native-reader), or to select use platform default / automatic (exact labels **TBD** UX). The mechanism **SHALL** be documented (e.g. path to executable, OS app picker, or registered handler id) per platform in DD without mandating a specific OS API herein.

**Acceptance criteria:** For each v1 type, user can set preferred, clear the choice to default, and open ([FR-019](./srs.md#fr-019--open-in-native-reader)) reflects the choice on a supported configuration; invalid or missing targets produce actionable error without crashing the client.

**Priority:** High

**Dependencies:** [FR-005](./srs.md#fr-005--supported-document-types-v1), [FR-019](./srs.md#fr-019--open-in-native-reader), [FR-020](./srs.md#fr-020--settings-client-preferences)
...
**Description:** Settings ([FR-020](./srs.md#fr-020--settings-client-preferences)) **SHALL** allow the user to select a visual theme for the shell UI, including at minimum these shipped defaults: (a) light, (b) dark, and (c) a warm sepia theme (e.g. sepia-tinted chrome and parchment-like background tones). Where the desktop platform exposes a system light/dark mode, the product SHOULD offer a match system option (or equivalent) that maps to light or dark only (sepia remains an explicit user choice unless documented otherwise in DD).

**Acceptance criteria:** User can switch among light, dark, and warm sepia and observe shell chrome and documented controls update accordingly; choice persists across restarts on the same client ([FR-020](./srs.md#fr-020--settings-client-preferences)). All shipped themes in (a)–(c) **SHALL** satisfy contrast for shell text and essential controls per [NFR-006](./srs.md#nfr-006--themed-shell-contrast) — including when warm sepia uses a parchment-style background, foreground (text, icons, borders) **SHALL** be chosen so WCAG 2.1 Level AA contrast obligations are met on representative surfaces.

**Priority:** Medium

**Dependencies:** [FR-020](./srs.md#fr-020--settings-client-preferences)

**Constraints:** Native reader appearance out of scope. Decorative parchment texture **MAY** be subtle provided legibility and [NFR-006](./srs.md#nfr-006--themed-shell-contrast) still pass.
...
**Acceptance criteria:** Documented accessibility test plan executed; critical flows (login, catalog browse [FR-037](./srs.md#fr-037--catalog-browse-sort-and-pagination), search, open document, Settings per [FR-020](./srs.md#fr-020--settings-client-preferences) (including logging [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)), access Help / user documentation per [NFR-007](./srs.md#nfr-007--end-user-documentation-and-help)) pass agreed checkpoints.
...
**Audit** capture **SHALL** default to enabled for the minimum event set above. An administrator **SHALL** be able to disable audit logging globally or per event category as documented in DD, subject to RBAC ([FR-031](./srs.md#fr-031--user-account-and-role-administration)); disabling **SHALL** require confirmation that surfaces compliance and forensics risk (exact UX DD). Timestamps **SHALL** use the server clock ([§8](./srs.md#8-assumptions)).

**Acceptance criteria:** With audit enabled, configured actions produce timestamped records with actor and resource identifier per DD; logs respect retention ([FR-028](./srs.md#fr-028--configurable-log-retention)); with audit disabled per policy, no new audit records for disabled categories are written except any mandatory bootstrap exceptions stated in DD; denied-access default behavior verified per DD.

**Priority:** Medium

**Dependencies:** [FR-016](./srs.md#fr-016--authentication-v1), [FR-017](./srs.md#fr-017--role-based-access-control), [FR-031](./srs.md#fr-031--user-account-and-role-administration)

**Constraints:** Privacy and retention are operator policy (see [§10](./srs.md#10-data-requirements), [§12](./srs.md#12-security-and-compliance-requirements), [NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness)).

**Notes:** Audit ([FR-026](./srs.md#fr-026--audit-logging)) is separate from operational/diagnostic ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)); multiplexed files allowed if categories remain discernible in DD.
...
**Notes:** Human-chosen password composition rules (length and character classes) are in [FR-033](./srs.md#fr-033--password-change-and-administrative-reset); storage here concerns hashing only.

---

## FR-028 — Configurable log retention

**Description:** The system **SHALL** provide administrator-configurable retention and rotation policy for all persistent log families the product controls: (a) audit logs ([FR-026](./srs.md#fr-026--audit-logging)) and (b) operational and diagnostic logs ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)). Enable/disable and day-based rollover for (b) are specified in [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server); this requirement ensures operators can also configure maximum retention (e.g. deletion or archival of files older than N days) per log family where policy or jurisdiction requires, with documented defaults and bounds (DD).

**Acceptance criteria:** Administrator (or documented operator role) can configure retention/rotation limits for audit separately from operational/diagnostic (or as documented if unified surface); behavior documented in admin guide ([NFR-004](./srs.md#nfr-004--operator-documentation)).

**Priority:** Medium

**Dependencies:** [FR-026](./srs.md#fr-026--audit-logging)

**Constraints:** Operational/diagnostic artifacts and their retention/rotation knobs are defined in [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server); this requirement unifies policy across log families. 
...
**Description:** The desktop client and the library server each **SHALL** emit two logging categories distinct in purpose from audit events ([FR-026](./srs.md#fr-026--audit-logging)) — though implementation MAY multiplex streams into files if categories remain individually controllable per below:
...
For each category on each component (client vs server), the product **SHALL** provide an independent enable/disable control exposed through Settings ([FR-020](./srs.md#fr-020--settings-client-preferences)) for client logs, and through the documented server administration interface (HLA—which MAY be the same shell app in solo deployments) for server logs, subject to RBAC ([FR-017](./srs.md#fr-017--role-based-access-control)).
...
**Rotation:** Operators **SHALL** be able to configure time-based rollover, including at minimum the number of days after which a log file rolls over to a new file (or equivalent documented semantics). Optional size-based rotation **MAY** complement time-based rotation (DD). Maximum retention (deletion or archival after N days) **SHALL** be configurable per [FR-028](./srs.md#fr-028--configurable-log-retention) and **SHALL** apply consistently to operational/diagnostic artifacts as documented.

**Acceptance criteria:** With operational enabled and diagnostic disabled on one component, new diagnostic-only content (per DD taxonomy) does not accumulate in persisted logs for that category (allow documented minimal bootstrap errors if unavoidable); converse configuration holds; both disabled stops routine persistence for both categories except any immutable minimum stated in DD; day-based rollover behavior is observable per DD; default paths and PII/secrets posture documented ([NFR-004](./srs.md#nfr-004--operator-documentation), [NFR-007](./srs.md#nfr-007--end-user-documentation-and-help), [NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness)).

**Priority:** High

**Dependencies:** [FR-017](./srs.md#fr-017--role-based-access-control), [FR-020](./srs.md#fr-020--settings-client-preferences), [FR-026](./srs.md#fr-026--audit-logging)

**Constraints:** Secrets, session tokens, passwords, and full document payloads **SHALL** not appear in cleartext in operational/diagnostic logs ([NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness)). Maximum retention and family-wide caps align with [FR-028](./srs.md#fr-028--configurable-log-retention).

**Notes:** Audit ([FR-026](./srs.md#fr-026--audit-logging)) remains governed by its own enablement/retention where applicable; diagnostic verbosity levels (e.g. debug) MAY be a separate DD topic if needed without violating the two-category toggle model above.
...
**Description:** Administrators **SHALL** be able to create, disable or re-enable, and delete local user accounts ([FR-016](./srs.md#fr-016--authentication-v1)), assign and revoke roles ([FR-017](./srs.md#fr-017--role-based-access-control)), and assign users to tenant membership ([FR-018](./srs.md#fr-018--tenant-boundary)) through a documented administration surface (Settings, dedicated admin UI, and/or documented CLI—HLA).

**Acceptance criteria:** Operations enforce RBAC and tenant rules (cross-tenant user assignment denied); last remaining administrator cannot be removed or disabled without documented transfer or replacement flow (DD); audit events emitted per [FR-026](./srs.md#fr-026--audit-logging) where audit is enabled.

**Priority:** High

**Dependencies:** [FR-016](./srs.md#fr-016--authentication-v1), [FR-017](./srs.md#fr-017--role-based-access-control), [FR-018](./srs.md#fr-018--tenant-boundary)

**Constraints:** —

**Notes:** Directory/SSO provisioning deferred ([§13](./srs.md#13-waiting-room-deferred-scope)).
...
**Dependencies:** [FR-016](./srs.md#fr-016--authentication-v1), [FR-031](./srs.md#fr-031--user-account-and-role-administration)
...
**Acceptance criteria:** Change and reset flows invalidate or preserve sessions per documented security policy ([FR-035](./srs.md#fr-035--session-management)); passwords violating the rules above are rejected with clear, actionable errors before persistence; compliant passwords are accepted and stored per [FR-027](./srs.md#fr-027--password-storage).

**Priority:** High

**Dependencies:** [FR-016](./srs.md#fr-016--authentication-v1), [FR-027](./srs.md#fr-027--password-storage), [FR-031](./srs.md#fr-031--user-account-and-role-administration)

**Constraints:** —

**Notes:** Self-service out-of-band recovery (e.g. email) remains in [§13](./srs.md#13-waiting-room-deferred-scope) unless promoted to scope. System-generated temporary passwords **SHALL** either satisfy the same composition rules or be usable only until the user sets a compliant password on first login per DD.

---

## FR-034 — Authentication throttling

**Description:** The library server **SHALL** throttle or temporarily lock authentication after a configurable threshold of failed attempts per documented identity key (e.g. username + source IP or client instance—DD). Defaults and maximum lockout duration **SHALL** be documented ([NFR-004](./srs.md#nfr-004--operator-documentation)).
...
**Description:** Server-validated sessions (or tokens) **SHALL** support administrator-configurable idle timeout and absolute maximum lifetime (documented defaults and bounds in DD). Explicit user logout from the client **SHALL** invalidate the session on the server for remote-capable deployments ([FR-013](./srs.md#fr-013--server-authority-for-security)).
...
**Notes:** v1 baseline uses **JWT access tokens** presented as `Authorization: Bearer` plus an **opaque refresh token** exchange flow (no cookie-based web session model for the API). Token binding to device fingerprinting deferred.

---

## FR-036 — Library corpus and storage model

**Description:** The server **SHALL** maintain the authoritative association between each catalog record (FR-001) and stored document bytes (path, object reference, or equivalent per HLA) within operator-configurable library storage roots or policies documented in [NFR-004](./srs.md#nfr-004--operator-documentation). Client open-in-reader ([FR-019](./srs.md#fr-019--open-in-native-reader)) **SHALL** not circumvent server authorization when the server mediates file access.

**Acceptance criteria:** Changing storage root or relocating corpus follows documented migration or relink story (DD); missing bytes surface per [FR-011](./srs.md#fr-011--missing-file-detection-and-relink).

**Priority:** High

**Dependencies:** [FR-001](./srs.md#fr-001--catalog-records), [FR-013](./srs.md#fr-013--server-authority-for-security), [FR-019](./srs.md#fr-019--open-in-native-reader)
...
**Description:** The shell **SHALL** provide a browse view listing catalog records visible to the user under RBAC, with documented sort options (e.g. title, date added, date modified) and pagination or virtualized scrolling so large libraries remain usable ([NFR-001](./srs.md#nfr-001--corpus-scale-qualitative) alignment).
...
**Description:** Full-text search ([FR-007](./srs.md#fr-007--full-text-search)) **SHALL** implement documented v1 query semantics including all of the following:
...
Matching **SHALL** be case-insensitive for basic Latin (other scripts per DD). Records matched only via keyword lists (FR-009) **SHALL** participate in queries per documented rules consistent with the same grammar where applicable. Search results **SHALL** support documented sort and pagination consistent with [FR-037](./srs.md#fr-037--catalog-browse-sort-and-pagination) where applicable. Fielded or metadata-only query syntax beyond full-text and keywords is optional for v1 and **SHALL** be specified in DD if shipped.
...
**Dependencies:** [FR-007](./srs.md#fr-007--full-text-search), [FR-009](./srs.md#fr-009--keywords-when-indexing-blocked)
...
**Description:** Administrators **SHALL** be able to trigger full or scoped rebuild of the full-text index ([FR-006](./srs.md#fr-006--full-text-indexing-when-permitted)) and to view index status (e.g. last successful build, in-progress job) per DD. Rebuild **SHALL** be safe to run while the system is online or **SHALL** document maintenance mode requirements (HLA).

**Acceptance criteria:** After corrupted index fixture, rebuild restores search per [FR-007](./srs.md#fr-007--full-text-search); progress or completion is observable per DD.

**Priority:** Medium

**Dependencies:** [FR-006](./srs.md#fr-006--full-text-indexing-when-permitted), [FR-031](./srs.md#fr-031--user-account-and-role-administration)
...
**Dependencies:** [FR-002](./srs.md#fr-002--metadata-fields), [FR-017](./srs.md#fr-017--role-based-access-control)
...
**Dependencies:** Test Plan, HLA, [FR-035](./srs.md#fr-035--session-management), [FR-037](./srs.md#fr-037--catalog-browse-sort-and-pagination), [FR-038](./srs.md#fr-038--search-query-semantics-and-results).
...
**Dependencies:** [FR-013](./srs.md#fr-013--server-authority-for-security), [FR-017](./srs.md#fr-017--role-based-access-control), [NFR-009](./srs.md#nfr-009--transport-security-remote-access) (remote transport security posture).
...
**Description:** The distributed source and binary artifacts **SHALL** include GPL-3.0-or-later license text and a notices/attribution practice consistent with the repository root as of release, and **SHALL** attribute third-party components as required by their licenses.

**Measurement criteria:** Release checklist verifies LICENSE and NOTICE presence and dependency attribution completeness.

**Constraints:** Legal review recommended before broad distribution (assumption [§8](./srs.md#8-assumptions)).
**Dependencies:** —
...
**Description:** The project **SHALL** publish operator documentation describing backup scope (corpus, database, index, configuration, logs), security boundaries, and privacy-relevant data flows at a conceptual level sufficient for informed deployment. The admin guide **SHALL** cover first-run bootstrap ([FR-032](./srs.md#fr-032--initial-administrator-bootstrap)), user and role administration ([FR-031](./srs.md#fr-031--user-account-and-role-administration)), import authorization (administrator-only default per [FR-004](./srs.md#fr-004--deliberate-import)), content digest persistence and algorithm identifiers ([FR-010](./srs.md#fr-010--duplicate-detection-digest)), missing-file detection and administrator notification defaults ([FR-011](./srs.md#fr-011--missing-file-detection-and-relink)), password composition policy as deployed ([FR-033](./srs.md#fr-033--password-change-and-administrative-reset)), session and lockout policy ([FR-034](./srs.md#fr-034--authentication-throttling), [FR-035](./srs.md#fr-035--session-management)), TLS and certificate handling ([NFR-009](./srs.md#nfr-009--transport-security-remote-access)), library storage roots ([FR-036](./srs.md#fr-036--library-corpus-and-storage-model)), index rebuild ([FR-039](./srs.md#fr-039--full-text-index-administration)), and time synchronization expectations ([§8](./srs.md#8-assumptions)). It **SHALL** identify default locations (or discovery method) for audit ([FR-026](./srs.md#fr-026--audit-logging)), operational, and diagnostic logs ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)) on each supported platform, summarize what each log family may contain, and reference retention/rollover controls ([FR-028](./srs.md#fr-028--configurable-log-retention), [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)) and jurisdictional considerations ([NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness)).
...
**Constraints:** Complements [NFR-007](./srs.md#nfr-007--end-user-documentation-and-help) (end-user / day-to-day documentation); admin vs end-user material MAY share a Help shell but SHALL remain discernible (e.g. separate sections or guides).
**Dependencies:** `system-documentation/user-documentation/` (e.g. admin guide); stubs to be expanded for release; [FR-004](./srs.md#fr-004--deliberate-import), [FR-010](./srs.md#fr-010--duplicate-detection-digest), [FR-011](./srs.md#fr-011--missing-file-detection-and-relink); [FR-026](./srs.md#fr-026--audit-logging) – [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server) (logging and retention); [FR-031](./srs.md#fr-031--user-account-and-role-administration), [FR-032](./srs.md#fr-032--initial-administrator-bootstrap), [FR-034](./srs.md#fr-034--authentication-throttling), [FR-035](./srs.md#fr-035--session-management), [FR-036](./srs.md#fr-036--library-corpus-and-storage-model), [FR-039](./srs.md#fr-039--full-text-index-administration); [NFR-009](./srs.md#nfr-009--transport-security-remote-access) (TLS).
...
**Dependencies:** [NFR-004](./srs.md#nfr-004--operator-documentation).
...
**Dependencies:** [FR-024](./srs.md#fr-024--shell-accessibility), [FR-022](./srs.md#fr-022--application-theme).
...
**Description:** The product **SHALL** ship end-user documentation in English ([FR-025](./srs.md#fr-025--english-ui-v1)), comprising at minimum: (a) a User manual describing primary shell workflows—including catalog browse ([FR-037](./srs.md#fr-037--catalog-browse-sort-and-pagination)); search semantics at user level ([FR-007](./srs.md#fr-007--full-text-search), [FR-038](./srs.md#fr-038--search-query-semantics-and-results)); metadata and tags including publication date and acquisition date where shown ([FR-002](./srs.md#fr-002--metadata-fields)); validation and edit conflicts ([FR-040](./srs.md#fr-040--metadata-validation), [FR-041](./srs.md#fr-041--concurrent-metadata-updates)); that document import is restricted to administrators (or documented import permission) and how solo users satisfy that role ([FR-004](./srs.md#fr-004--deliberate-import), [FR-014](./srs.md#fr-014--solo-co-located-deployment), [FR-032](./srs.md#fr-032--initial-administrator-bootstrap)); missing-file or degraded-access behavior for the reader’s role ([FR-011](./srs.md#fr-011--missing-file-detection-and-relink)); open in native reader ([FR-019](./srs.md#fr-019--open-in-native-reader)) and reader preferences ([FR-021](./srs.md#fr-021--preferred-reader-per-document-type)); Settings ([FR-020](./srs.md#fr-020--settings-client-preferences)); password change ([FR-033](./srs.md#fr-033--password-change-and-administrative-reset)); logout and session behavior summary ([FR-035](./srs.md#fr-035--session-management)); client operational/diagnostic logging controls and default log locations ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)); and RBAC-visible behavior (e.g. denied access and tenant visibility)—and (b) a Quick-start guide sufficient for a new user to install or connect the client, complete or skip bootstrap per role ([FR-032](./srs.md#fr-032--initial-administrator-bootstrap)), authenticate if required, and as a user who may perform import (administrator in typical solo or multi-user setups per [FR-004](./srs.md#fr-004--deliberate-import)), import at least one document successfully. Source MAY be maintained under `system-documentation/user-documentation/` (or successor path) and **SHALL** be packaged or published with releases per HLA (e.g. HTML, PDF, Markdown bundle—exact formats TBD).
...
**Constraints:** Searchable full in-app help index, context-sensitive (F1) help, and very large manual browse/search UX are deferred to §13 unless implemented early via a chosen component. A pre-built help component or viewer MAY be used provided licenses are compatible with GPL-3.0-or-later distribution (or are clearly optional), security posture is acceptable, and accessibility ([FR-024](./srs.md#fr-024--shell-accessibility)) obligations are met for the help surface.

**Dependencies:** [FR-002](./srs.md#fr-002--metadata-fields), [FR-004](./srs.md#fr-004--deliberate-import), [FR-011](./srs.md#fr-011--missing-file-detection-and-relink), [FR-025](./srs.md#fr-025--english-ui-v1), [FR-024](./srs.md#fr-024--shell-accessibility), [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server), [FR-033](./srs.md#fr-033--password-change-and-administrative-reset), [FR-035](./srs.md#fr-035--session-management), [FR-037](./srs.md#fr-037--catalog-browse-sort-and-pagination), [FR-038](./srs.md#fr-038--search-query-semantics-and-results), [FR-040](./srs.md#fr-040--metadata-validation), [FR-041](./srs.md#fr-041--concurrent-metadata-updates), [NFR-004](./srs.md#nfr-004--operator-documentation), [NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness) (operator docs distinct but may cross-link).
...
**Dependencies:** [FR-026](./srs.md#fr-026--audit-logging), [FR-028](./srs.md#fr-028--configurable-log-retention), [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server), [NFR-004](./srs.md#nfr-004--operator-documentation).
...
**Dependencies:** [FR-013](./srs.md#fr-013--server-authority-for-security), [FR-014](./srs.md#fr-014--solo-co-located-deployment), [NFR-004](./srs.md#nfr-004--operator-documentation).
...
- The system **SHALL** surface when text used for search is OCR-derived or otherwise unreliable per [FR-023](./srs.md#fr-023--ocr-for-searchability) and DD.
...
- **License:** GPL-3.0-or-later for project code as stated in repository.
- No DRM circumvention as a product goal.
- English-first UI.
- **Symbolic links:** unsupported** in v1 for library paths.
- **Network:** Remote access **SHALL** meet [NFR-009](./srs.md#nfr-009--transport-security-remote-access); operators supply certificates and trust policy per [NFR-004](./srs.md#nfr-004--operator-documentation).
...
- Third-party OCR/parser licenses remain compatible with GPL-3.0-or-later distribution or are optional plug-ins clearly separated (TBD HLA).
- Trustworthy timestamps for audit and logs depend on accurate server (and where applicable client) system time; operators **SHALL** maintain time sync (e.g. NTP) per [NFR-004](./srs.md#nfr-004--operator-documentation) guidance—the product does not replace an authoritative time source.
...
- Operational and diagnostic log files ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)) **SHALL** reside at platform-appropriate paths per HLA; server log paths **SHALL** follow service/daemon conventions per OS.
...
- **Passwords:** hashed only ([FR-027](./srs.md#fr-027--password-storage)).
- **Audit logs:** personal data in some jurisdictions; purpose limitation and retention operator-configured ([FR-028](./srs.md#fr-028--configurable-log-retention), [NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness)).
- **Operational and diagnostic logs ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)):** **MAY** contain identifiers, paths, or other personal data; minimization and retention **SHALL** align with [NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness) and operator policy.
- **Client preferences ([FR-020](./srs.md#fr-020--settings-client-preferences)–[FR-022](./srs.md#fr-022--application-theme), [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server), and other client-held settings):** **SHALL NOT** be used to store server secrets or to bypass authorization; backup scope **MAY** include client preference stores where operators document enterprise restore practices (solo: typically user-local). Server-side administration data ([FR-031](./srs.md#fr-031--user-account-and-role-administration)–[FR-035](./srs.md#fr-035--session-management), [FR-039](./srs.md#fr-039--full-text-index-administration)) **SHALL** be durable and included in operator backup guidance ([NFR-004](./srs.md#nfr-004--operator-documentation)).
- **Backups:** ideal includes corpus + DB + index + config + logs; minimal subset documented for operators ([NFR-004](./srs.md#nfr-004--operator-documentation)).
...
- Concurrent edits to the same catalog record’s metadata **SHALL** follow [FR-041](./srs.md#fr-041--concurrent-metadata-updates) (optimistic concurrency): stale updates fail without silent overwrite; the client **SHALL** support refresh and retry per DD; an optional explicit user overwrite after conflict **MAY** be offered per DD (if offered, **SHALL** be documented and tested).
...
- Authentication and RBAC per [FR-016](./srs.md#fr-016--authentication-v1)–[FR-018](./srs.md#fr-018--tenant-boundary).
- Multi-factor authentication (MFA) is not required in v1 and is out of scope unless reopened ([§2.2](./srs.md#22-scope)); any future MFA **SHALL** be optional per deployment. Passkey / WebAuthn sign-in is deferred as a candidate capability ([§13](./srs.md#13-waiting-room-deferred-scope)).
- Client Settings ([FR-020](./srs.md#fr-020--settings-client-preferences)) **SHALL NOT** allow elevation of privilege or access to documents contrary to server decisions; UI hiding alone is insufficient for security on remote deployments ([FR-013](./srs.md#fr-013--server-authority-for-security)).
- Transport security for remote access **SHALL** satisfy [NFR-009](./srs.md#nfr-009--transport-security-remote-access); loopback solo profiles per documented HLA exception.
- Audit optional events per [FR-026](./srs.md#fr-026--audit-logging) with privacy awareness.
- **Operational/diagnostic logs ([FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server)):** Where viewing or export is exposed in UI, access **SHALL** respect RBAC ([FR-017](./srs.md#fr-017--role-based-access-control)). Log content **SHALL** satisfy [NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness) (no cleartext secrets, session tokens, passwords, or full document payloads in operational/diagnostic streams).
- **Regulatory:** Operators remain responsible for lawful processing; the product provides controls and documentation (including [NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness)) but not legal advice or jurisdiction-specific certification.
- Accessibility law alignment targeted via [FR-024](./srs.md#fr-024--shell-accessibility); jurisdiction-specific claims deferred to counsel.
...
| ------------------------------------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Extraction/OCR inaccuracy**               | **High**         | [§6](#6-deterministicprobabilistic-requirements "6. Deterministic-Probabilistic Requirements "6. Deterministicprobabilistic Requirements"), [FR-023](./srs.md#fr-023--ocr-for-searchability), [FR-007](./srs.md#fr-007--full-text-search) honest semantics             |
| **Search query parsing / user expectation** | **Moderate**     | [FR-038](./srs.md#fr-038--search-query-semantics-and-results) normative grammar, golden fixtures, [NFR-007](./srs.md#nfr-007--end-user-documentation-and-help)                                                                                                         |
| **Non-administrator expects to import**     | **Low–Moderate** | [FR-004](./srs.md#fr-004--deliberate-import), [NFR-007](./srs.md#nfr-007--end-user-documentation-and-help), RBAC messaging                                                                                                                                             |
| **User expects SharePoint parity**          | **Moderate**     | [§2.2](./srs.md#22-scope) non-goals, operator docs                                                                                                                                                                                                                     |
| **Remote access misconfiguration**          | **High**         | [NFR-002](./srs.md#nfr-002--server-side-enforcement), [NFR-004](./srs.md#nfr-004--operator-documentation), [NFR-009](./srs.md#nfr-009--transport-security-remote-access), HLA                                                                                          |
| **Credential / session abuse**              | **High**         | [FR-034](./srs.md#fr-034--authentication-throttling), [FR-035](./srs.md#fr-035--session-management), [NFR-009](./srs.md#nfr-009--transport-security-remote-access), [FR-033](./srs.md#fr-033--password-change-and-administrative-reset)                                |
| **Concurrent-edit data loss**               | **Moderate**     | [FR-041](./srs.md#fr-041--concurrent-metadata-updates)                                                                                                                                                                                                                 |
| **Legal/DRM boundary**                      | **Moderate**     | [FR-006](./srs.md#fr-006--full-text-indexing-when-permitted), [FR-009](./srs.md#fr-009--keywords-when-indexing-blocked), [§7](./srs.md#7-constraints)                                                                                                                  |
| **Accessibility verification gaps**         | **Moderate**     | [FR-024](./srs.md#fr-024--shell-accessibility) + Test Plan                                                                                                                                                                                                             |
| **Documentation / Help gaps**               | **Moderate**     | [NFR-007](./srs.md#nfr-007--end-user-documentation-and-help) checklist, Quick-start test                                                                                                                                                                               |
| **Scope creep (web/API)**                   | **Moderate**     | [§13](./srs.md#13-waiting-room-deferred-scope) waiting room                                                                                                                                                                                                            |
| **Reader preference misconfiguration**      | **Low–Moderate** | [FR-021](./srs.md#fr-021--preferred-reader-per-document-type) acceptance, clear fallback                                                                                                                                                                               |
| **Logging / retention compliance**          | **Moderate**     | [FR-029](./srs.md#fr-029--operational-and-diagnostic-logging-client-and-server), [FR-028](./srs.md#fr-028--configurable-log-retention), [NFR-004](./srs.md#nfr-004--operator-documentation), [NFR-008](./srs.md#nfr-008--logging-privacy-and-jurisdictional-readiness) |
