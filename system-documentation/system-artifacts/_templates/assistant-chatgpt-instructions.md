<!--
File: system-documentation/system-artifacts/_templates/assistant-chatgpt-instructions.md
...
and enforced through:
    ...
    system-documentation/system-artifacts/ (concept, SRS, HLA, DD, tests, RTM, packaging)
    system-documentation/system-artifacts/_templates/
    .cursor/rules/cursor-rules.mdc

This file governs assistant behavior only.
Lifecycle authority resides in LIFECYCLE.md (path above).
-->
...
- system-documentation/system-artifacts/LIFECYCLE.md  
- system-documentation/system-artifacts/ (authoritative artifacts as they exist)  
- system-documentation/system-artifacts/_templates/ (scaffolds; copy before use)  
- .cursor/rules/cursor-rules.mdc (Cursor behavior)  
